...
if(imgsize == '620' or imgsize == '1000'):
	...
	imgw = str(im3.size[0])
	imgh = str(im3.size[1])
	img_name = 'averageprecip-30avg8110-cmb--'+imgw+'x'+imgh+'--0000-'+mm+'-00.png'
...
if(imgsize == 'DIY'):
	...
	img_name = 'averageprecip-normals-cmb--'+imgw+'x'+imgh+'--0000-'+mm+'-00.png'
	cmd = 'mv '+im1+' '+img_name
	subprocess.call(cmd, shell=True)
	im2 = "./temporary_cbar.eps"
	cbar_name = 'averageprecip-normals-cmb--0000-'+mm+'-00_colorbar.eps'
	cmd = 'mv '+im2+' '+cbar_name
	subprocess.call(cmd, shell=True)	
	cmd1 = 'zip averageprecip-normals-cmb--'+imgw+'x'+imgh+'--0000-'+mm+'-00.zip '+img_name+' '+cbar_name+' noaa_logo.eps '
	subprocess.call(cmd1, shell=True)
	cmd2 = 'mv averageprecip-normals-cmb--'+imgw+'x'+imgh+'--0000-'+mm+'-00.zip '+img_path
...
if(imgsize == 'HD'):
	...
	ttext = "Normal precipitation (inches)"
	...
	img_path = './Images/Precipitation/'+imgsize.lower()+'/'
	img_name = 'averageprecip-normals-cmb--'+imgw+'x'+imgh+'hd--0000-'+mm+'-00.png'
	pngfile = img_path+img_name
	print "Saving "+pngfile
	hdim.save(pngfile)
...
if(imgsize == 'HDSD'):
	...
	img_path = './Images/Precipitation/'+imgsize.lower()+'/'
	img_name = 'averageprecip-normals-cmb--'+imgw+'x'+imgh+'hdsd--0000-'+mm+'-00.png'
	pngfile = img_path+img_name
	print "Saving "+pngfile
	hdim.save(pngfile)