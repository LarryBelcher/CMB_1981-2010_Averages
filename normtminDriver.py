...
p1 = subprocess.Popen("python normtminMap.py "+mm+" "+imgsize, shell=True)
p1.wait()


p2 = subprocess.Popen("python normtminColorbar.py "+mm+" "+imgsize, shell=True)
p2.wait()
...
if not os.path.isdir('./Images/Temperature/Tmin/'+imgsize):
	cmd = 'mkdir ./Images/Temperature/Tmin/'+imgsize.lower()
	subprocess.call(cmd,shell=True)
...
if(imgsize == '620' or imgsize == '1000'):
	...
	im3.paste(im1, (0,0))
	img_path = './Images/Temperature/Tmin/'+imgsize+'/'
	imgw = str(im3.size[0])
	imgh = str(im3.size[1])
	if(mm == '00'): monthstr='No-Data'
	img_name = 'averagemintemp-'+monthstr+'-1981-2010-cmb--'+imgw+'x'+imgh+'--0000-'+mm+'-00.png'
...
if(imgsize == 'DIY'):
	...
	if(mm == '00'): monthstr='No-Data'
	img_path = './Images/Temperature/Tmin/'+imgsize.lower()+'/'
	img_name = 'averagemintemp-'+monthstr+'-1981-2010-cmb--'+imgw+'x'+imgh+'--0000-'+mm+'-00.png'
	cmd = 'mv '+im1+' '+img_name
	subprocess.call(cmd,shell=True)
	im2 = "./temporary_cbar.eps"
	cbar_name = 'averagemintemp-'+monthstr+'-1981-2010-cmb--0000-'+mm+'-00_colorbar.eps'
	cmd = 'mv '+im2+' '+cbar_name
	subprocess.call(cmd,shell=True)
	cmd1 = 'zip averagemintemp-'+monthstr+'-1981-2010-cmb--'+imgw+'x'+imgh+'--0000-'+mm+'-00.zip '+img_name+' '+cbar_name+' noaa_logo.eps '
	subprocess.call(cmd1,shell=True)
	cmd2 = 'mv averagemintemp-'+monthstr+'-1981-2010-cmb--'+imgw+'x'+imgh+'--0000-'+mm+'-00.zip '+img_path
...
if(imgsize == 'HD'):
	...
	ttext = "Average minimum temperature 1981-2010"
	...
	img_path = './Images/Temperature/Tmin/'+imgsize.lower()+'/'
	img_name = 'averagemintemp-'+monthstr+'-1981-2010-cmb--'+imgw+'x'+imgh+'hd--0000-'+mm+'-00.png'
	pngfile = img_path+img_name
	print "Saving "+pngfile
	hdim.save(pngfile)
...
if(imgsize == 'HDSD'):
	...
	img_path = './Images/Temperature/Tmin/'+imgsize.lower()+'/'
	img_name = 'averagemintemp-'+monthstr+'-1981-2010-cmb--'+imgw+'x'+imgh+'hdsd--0000-'+mm+'-00.png'
	pngfile = img_path+img_name
	print "Saving "+pngfile
	hdim.save(pngfile)